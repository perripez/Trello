...
class CardSchema(ma.Schema):
    ...
    title = fields.String(required=True, validate=And(Length(min=4, error="Title must be at least 4 characters in length."), Regexp('^[A-Z][A-Za-z0-9 ]+$', error="Title must start with a capital letter and have alphanumeric characters only"))) #From regexr.com
    ...
    def validate_status(self, value):
        # if trying to set the value as "In Progress"
